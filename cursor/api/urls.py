...
from .views import ProductView, ProductSingleView, CategoryProductsView, OrdersView,  OrderSingleView, OrderCreateView
...
urlpatterns = [
    ...
    path("v2/orders/", OrdersView.as_view()),
    path("v2/orders/<int:id>", OrderSingleView.as_view()),
    path("v2/order-create", OrderCreateView.as_view()),
